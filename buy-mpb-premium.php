...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly 
	wp_enqueue_style('awl-bootstrap-css', MPB_PLUGIN_URL . 'css/bootstrap.css');
?>
<div class="wrap">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			<h1 class="text-center"><em><a href="http://awplife.com/product/model-popup-box-premium-plugin-for-wordpress/">Model Popup Box Premium Plugin</a></em></h1>
			<h1 class="text-center">Buy Premium Plugin settings, Fully Customization ,Content Settings ,Modal Form Footer Button Settings ,Full Responsive Slider ,Animation</h1><br>
			
			<div class="thumbnail col-md-6"><br><br>
				<h2 class="text-center">Model Popup Box Premium Plugin For All Devices</h2><br><br><hr>	
				<img class="" src="<?php echo MPB_PLUGIN_URL . 'img/modal-pop-up-box.png' ?>"/><br>
				<h2 class="text-center"><a class="btn btn-primary btn-lg" href="http://awplife.com/account/signup/model-popup-box-premium/">Purchase Now</a></h2><br>
			</div>
			<div class="thumbnail col-md-6">
				<img class="" src="<?php echo MPB_PLUGIN_URL . 'img/modal-popup-box.png' ?>"/>
			</div>
				<style>
					.awp_bale_offer {
